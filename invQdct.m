function [mbDCT_dequant_img,MBdq_IDCT] = invQdct(mbDCT_quantout,H,W,ql)
%% for Video motion estimation
f1=ones(1,W/8);
f2=ones(1,H/8);
f1=f1*8;
f2=f2*8;
mbDCT_Qout = mat2cell(mbDCT_quantout,f2,f1);
...
MBdq_IDCT = cell2mat(MB_idct)/255;
