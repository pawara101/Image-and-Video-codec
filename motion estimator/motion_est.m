function [pf_out,Br_out] = motion_est(inFile1,inFile2,N,W)
% pf = predicted frame
% bf = reconstructed image
...
%
pf_out = uint8(round(pf));
Br_out = uint8(round(Br));

% figure;imshow(uint8(round(pf)));title('predicted image');
